...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.sikaseal.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.sikaseal.security.DomainUserDetailsService", "createSpringSecurityUser");
