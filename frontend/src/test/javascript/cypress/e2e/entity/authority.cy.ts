...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '8ce78fdf-b117-45e8-9219-5dcd54afcef4' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('98e69e62-6089-49e7-9c89-70ee181fe2d5');
      cy.get(`[data-cy="name"]`).should('have.value', '98e69e62-6089-49e7-9c89-70ee181fe2d5');
